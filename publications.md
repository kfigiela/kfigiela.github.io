...
1. Maciej Malawski, **Kamil Figiela**, Marian Bubak, Ewa Deelman and Jarek Nabrzyski, *Scheduling multi-level deadline-constrained scientific workflows on clouds based on cost optimization*, Scientific Programming (in print), IOS Press, 2014, [doi:10.3233/SPR-140406](http://dx.doi.org/10.3233/SPR-140406).
